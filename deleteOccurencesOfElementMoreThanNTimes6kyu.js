...
// you take [1,2,3,1,2], drop the next [1,2] since this would lead to 1
// and 2 being in the result 3 times, and then take 3, which
...
function deleteNth(arr, n) {
  ...
  for (let i = items.length; i > 0; i--) {
    if (items.filter((num) => num === items[i]).length > n) {
