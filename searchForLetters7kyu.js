...
// based on the fact whether the Nth letter of the alphabet is
...
const change = (string) => ' '.repeat(26).split('').map((item, index) => (string.toLowerCase().includes(String.fromCharCode(97 + index)) ? '1' : '0')).join('');
